...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($judul !== '' && $isi !== '' && $id_kategori > 0 && empty($error_msg)) {
        ...
        if (isset($_FILES['gambar_cover']) && $_FILES['gambar_cover']['error'] === UPLOAD_ERR_OK) {
            ...
            // Check size (2MB max) and extension
            if (in_array($fileExtension, $allowedExtensions) && $fileSize <= 2 * 1024 * 1024) {
                ...
                $error_msg = "Unggahan gagal. Pastikan format gambar JPG/PNG/WEBP dan ukuran < 2MB.";
            }
        }
            ...
            <div class="card-body p-4 p-md-5">
                ...
                <form action="tambah_berita.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text text-muted small mt-1.5">Opsional. Format yang diperbolehkan: JPG, JPEG, PNG, WEBP. Maksimal 2MB.</div>
                    </div>
